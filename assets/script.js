...
var charList = {
    ...
    char3: {
        ...
        story: {
            ...
            winText: "As the announcer falls, you pause to read the crowd, curious as to whether they will cheer the death of their leader.</p><p>To your relief, the crowd erupts into uproarious cheer. You stand straight and begin to bow repeatedly and wave to the audience. When spectators begin to enter the arena grounds, you fish a smoke pellet from your belt and palm it discreetly, waiting for your new fans to approach.</p><p>Before the crowd gets too close, you smash the pellet and surround yourself and the announcer in smoke. Quickly, you loot his body, searching for gold, valuables, and booze. Unfortunately, with time only for a cursory glance, you only find the heavy sword he used in battle. You deem it too heavy and unwieldly to use or steal and quickly shed your cloak. </p><p>As the first fans approach, you mix in with the crowd, using the excitement and confusion to slip away.</p><p>Outside the arena, you make your way to the nearest pub in search of ale and women.",
        },
